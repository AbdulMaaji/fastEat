...
import { History, MapPin, CreditCard, ChevronRight, LogOut } from 'lucide-react';
...
const ProfilePage: React.FC = () => {
    const {
        ...
        setCurrentUser,
        setCurrentUserRole,
        setAuthScreen // This might need to be moved to context or handled differently
    } = useAppContext();
                ...
                <div className="space-y-6">
                    ...
                    <button
                        onClick={() => {
                            ...
                            // setAuthScreen(true); // TODO: Handle auth screen via router or context
                        }}
                        className="w-full mt-4 flex items-center justify-center p-3 text-red-500 font-bold text-xs bg-red-50 rounded-xl hover:bg-red-100 transition-colors"
                    >
